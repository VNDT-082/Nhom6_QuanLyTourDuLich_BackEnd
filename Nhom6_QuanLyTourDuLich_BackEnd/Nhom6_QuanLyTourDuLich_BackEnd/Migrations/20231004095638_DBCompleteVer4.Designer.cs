...
namespace Nhom6_QuanLyTourDuLich_BackEnd.Migrations
{
    ...
    [Migration("20231004095638_DBCompleteVer4")]
    partial class DBCompleteVer4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Nhom6_QuanLyTourDuLich_BackEnd.Data.DatTourEntity", b =>
                {
                    ...
                    b.Property<DateTime>("ngayDat")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 4, 16, 56, 38, 313, DateTimeKind.Local).AddTicks(8680));
            ...
            modelBuilder.Entity("Nhom6_QuanLyTourDuLich_BackEnd.Data.NhanVienEntity", b =>
                {
                    ...
                    b.Property<DateTime>("ngayVaoLam")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 4, 16, 56, 38, 314, DateTimeKind.Local).AddTicks(104));
            ...
            modelBuilder.Entity("Nhom6_QuanLyTourDuLich_BackEnd.Data.TaiKhoanEntity", b =>
                {
                    ...
                    b.Property<DateTime?>("ngayLap")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 4, 16, 56, 38, 314, DateTimeKind.Local).AddTicks(2039));
            ...
            modelBuilder.Entity("Nhom6_QuanLyTourDuLich_BackEnd.Data.TourEntity", b =>
                {
                    ...
                    b.Property<DateTime>("ngayLap")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 4, 16, 56, 38, 314, DateTimeKind.Local).AddTicks(3235));
