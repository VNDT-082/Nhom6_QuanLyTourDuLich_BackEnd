...
namespace Nhom6_QuanLyTourDuLich_BackEnd.Migrations
{
    ...
    [Migration("20231023025511_DBUpdateVer14")]
    partial class DBUpdateVer14
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Nhom6_QuanLyTourDuLich_BackEnd.Data.DatTourEntity", b =>
                {
                    ...
                    b.Property<DateTime>("ngayDat")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 23, 9, 55, 11, 627, DateTimeKind.Local).AddTicks(5749));
            ...
            modelBuilder.Entity("Nhom6_QuanLyTourDuLich_BackEnd.Data.HoiDapEntity", b =>
                {
                    ...
                    b.Property<DateTime>("ngayDang")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 23, 9, 55, 11, 629, DateTimeKind.Local).AddTicks(486));
            ...
            modelBuilder.Entity("Nhom6_QuanLyTourDuLich_BackEnd.Data.NhanVienEntity", b =>
                {
                    ...
                    b.Property<DateTime>("ngayVaoLam")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 23, 9, 55, 11, 628, DateTimeKind.Local).AddTicks(1832));
            ...
            modelBuilder.Entity("Nhom6_QuanLyTourDuLich_BackEnd.Data.NhanXetEntity", b =>
                {
                    ...
                    b.Property<DateTime>("ngayDang")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 23, 9, 55, 11, 628, DateTimeKind.Local).AddTicks(9792));
            ...
            modelBuilder.Entity("Nhom6_QuanLyTourDuLich_BackEnd.Data.TaiKhoanEntity", b =>
                {
                    ...
                    b.Property<DateTime?>("ngayLap")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 23, 9, 55, 11, 628, DateTimeKind.Local).AddTicks(6308));
            ...
            modelBuilder.Entity("Nhom6_QuanLyTourDuLich_BackEnd.Data.TourEntity", b =>
                {
                    ...
                    b.Property<DateTime>("ngayLap")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 23, 9, 55, 11, 628, DateTimeKind.Local).AddTicks(9060));
            ...
            modelBuilder.Entity("Nhom6_QuanLyTourDuLich_BackEnd.Data.TraLoiHoiDapEntity", b =>
                {
                    ...
                    b.Property<DateTime>("ngayTraLoi")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 23, 9, 55, 11, 629, DateTimeKind.Local).AddTicks(1057));
